-- link para o material: https://www.cursoemvideo.com/curso/mysql/
-- créditos: Curso em Video

CREATE DATABASE  IF NOT EXISTS `cadastroCeV` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
